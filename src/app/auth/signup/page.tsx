          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Start managing projects smarter with automated workflows
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 text-center">
                <Link
                  href="/auth/login"
                  className="inline-flex items-center justify-center w-full py-2.5 px-4 border-2 border-gray-200 rounded-lg text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-all duration-200"
                >
                  Sign in instead
                </Link>
              </div>
        ...
        <div className="w-full max-w-lg text-white">
          <div className="mb-8">
            ...
            <p className="text-lg text-blue-100">
              Start automating your workflows and boost productivity today
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-5 hover:bg-white/15 transition-all">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">
                  Quick onboarding process to get your team started instantly.
                </p>
              </div>
            </div>
