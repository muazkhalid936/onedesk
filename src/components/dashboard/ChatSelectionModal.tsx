...
export default function ChatSelectionModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white/95 dark:bg-gray-800/95 rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[80vh] overflow-hidden">
        {/* Header */}
          ...
          {filteredChats.length === 0 ? (
            ...
            <div className="space-y-2">
              {filteredChats.map((chat) => (
                ...
                >
                  <div className="flex-shrink-0">{getChatIcon(chat.type)}</div>
